...
// 보스 공격 사이클
// 기본 탄환 연사 -> 2초 대기 -> 스킬 1회 -> 2초 대기 -> 반복
let bossCyclePhase = "basic";
let bossCycleTimer = 4;
let bossBasicShotTimer = 0;
const bossBasicDuration = 4;
const bossBasicShotInterval = 0.18;
const bossPhasePause = 2;
...
function spawnBoss() {
    ...
    bossCyclePhase = "basic";
    bossCycleTimer = bossBasicDuration;
    ...
    if (
        ...
        if (boss) {
            ...
            if (bossCyclePhase === "basic") {
                ...
                if (bossCycleTimer <= 0) {
                    bossCyclePhase = "pause_before_skill";
                    bossCycleTimer = bossPhasePause;
                    bossBasicShotTimer = bossBasicShotInterval;
                }

            } else if (bossCyclePhase === "pause_before_skill") {

                if (bossCycleTimer <= 0) {
                    bossShoot(boss);
                    bossCyclePhase = "pause_after_skill";
                    bossCycleTimer = bossPhasePause;
                }

            } else if (bossCyclePhase === "pause_after_skill") {
